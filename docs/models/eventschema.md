...
```typescript
import { EventSchema } from "owasp-nest/models";

let value: EventSchema = {
  description: "searchingly meanwhile challenge",
  name: "<value>",
  endDate: new Date("2024-09-25T19:09:08.810Z"),
  startDate: new Date("2023-11-02T05:01:46.087Z"),
  url: "https://acidic-commodity.info",
};
```
