 ...
 */
export function committeesListCommittees(
  client: NestCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCommitteesRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PagedCommitteeSchema$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
