 ...
 */
export function communityListMembers(
  client: NestCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMembersRequest$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PagedMemberSchema$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
