 ...
 */
export function milestonesGetMilestone(
  client: NestCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMilestoneRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MilestoneDetail$inboundSchema),
    M.jsonErr(404, errors.MilestoneError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
