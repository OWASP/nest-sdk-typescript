 ...
 */
export function releasesGetRelease(
  client: NestCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetReleaseRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    release_id: encodeSimple("release_id", payload.release_id, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReleaseDetail$inboundSchema),
    M.jsonErr(404, errors.ReleaseError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
