 ...
 */
export function sponsorsListSponsors(
  client: NestCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSponsorsRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/api/v0/sponsors/")();
